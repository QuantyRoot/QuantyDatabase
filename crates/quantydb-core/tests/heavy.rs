...
//!
//!     cargo test -p quantydb-core --release --test heavy -- --ignored --nocapture

use std::time::Instant;

use quantydb_core::{encode_key, Db, MemStorage, PagerOptions, Value};
...
fn a_gigabyte_goes_in_and_out_without_being_held() {
    ...
    assert_eq!(blob.chunks.len(), GIB / quantydb_core::CHUNK_SIZE);
    assert_eq!(
