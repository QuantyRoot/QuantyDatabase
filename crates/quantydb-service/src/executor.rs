...
use quantydb_exec::{Parked, Session};
use quantydb_proto::{ClientMessage, ErrorCode, ServerMessage};
use quantydb_ql::ast::Statement;
use quantydb_server::{ConnId, Dispatch, Job};
...
impl Executor {
    ...
    /// case docs/PROTOCOL.md already describes and the reason `quantydb serve`
